...
The accuracies reported in the training scripts average over all subsets.
"""
...
if __name__ == "__main__":
    ...
    model = ProgramRNN( train_args.z_dim, label_dim, len(vocab['w2i']), embedding_dim=train_args.embedding_dim, 
                        hidden_dim=train_args.hidden_dim, num_layers=train_args.num_layers)
    ...
    for i in xrange(1, len(ZIPF_CLASS)):  # we don't care about the HEAD

r"""Utilities specific to problem 5 (out of 8)."""
...
LOOP_LABELS_IX = [0, 1, 2, 3, 4, 13, 14, 15, 18, 20, 22, 25]
GEOMETRY_LABELS_IX = [5, 7, 8, 10, 11, 17, 24]

STUDENT_PCFG_PARAMS = [95, 4, 80, 5, 5, 2, 2, 10, 5, 100, 2, 2, 2, 100, 2, 6, 1, 6, 2, 2, 93, 7, 100, 100, 100, 10, 100, 5, 100, 10, 90, 90, 10, 100, 3, 80, 5, 1, 1, 5, 100, 5, 1, 1, 2, 90, 1, 1, 100, 100, 3, 100, 5, 100, 1, 25, 20, 20, 10, 50, 0.05]
